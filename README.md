Resumen de Evidencias – Publicación de Portafolio
Nº
Evidencia
Descripción
Estado
...
Adjuntas en el documento
3
Documento adicional
Informe con pasos realizados, comandos utilizados y estructura de archivos
Este documento en PDF


Evidencia – Publicación de Portafolio en GitHub Pages
1. Introducción
Este documento describe el proceso realizado para subir mi portafolio a GitHub y publicarlo en línea mediante GitHub Pages. El objetivo fue obtener una dirección web personalizada para compartir mi trabajo con reclutadores y colegas.
...
Subí los archivos al repositorio remoto con el comando:
